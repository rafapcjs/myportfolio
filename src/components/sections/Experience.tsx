  ...
  return (
    ...
    >
      <div className="container-page">
        ...
        <TimelineTrack className="ml-2 sm:ml-3">
          <ol>
            {experience.map((item) => {
              ...
              return (
                <li key={item.id} className="relative pb-12 pl-8 last:pb-0 sm:pl-10">
                  <Reveal
                    variant="pop"
                    className="absolute top-1.5 -left-[7px] h-3.5 w-3.5"
                    delay={0.1}
                  >
                    <span
                      aria-hidden="true"
                      className={cn(
                        "block h-3.5 w-3.5 rounded-full border-2 border-bg",
                        isCurrent
                          ? "bg-accent-2 shadow-[0_0_0_4px] shadow-accent-2/25"
                          : "bg-accent",
                      )}
                    />
                  </Reveal>
